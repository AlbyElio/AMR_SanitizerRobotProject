...
class EnergyPublication (Node):
    def __init__(self):
        super().__init__('EnergyPublication')
    ...
    def ok_callback(self, msg):
        ...
        self.get_logger().info('OK ACQUIRED')
    ...
    def timer_callback(self):
        if self.energy_matrix  is not None and self.localization_ok == True :
    ...
    def energy_evaluation(self):
        ...
        if self.pub_time  is not None and self.localization_ok:
            ########## ENERGY DEFINITION ##########
...
def main(args=None):
    ...
    energy_pub_node = EnergyPublication()
